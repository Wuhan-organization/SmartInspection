...
public class VideoViewer extends SurfaceView implements IVLCVout.Callback {
    ...
    private void init() {
        ...
        SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(HelmetActivity.getAppContext()) ;
...
//                toast.show();
            ...
            //releasePlayer();
            Toast.makeText(HelmetActivity.getAppContext(), "Error creating player!", Toast.LENGTH_LONG).show();
        }
    }
