...
public class BaseHttpComponent {
	...
	//获取变电站名称列表
	public static final String URL_SUBSTATION = "http://119.29.191.32:8080/BDZXJService/Android/Substation/all";
	//任务提交
	...
	//任务查询
	public static final String URL_TASK = "http://119.29.191.32:8080/BDZXJService/Android/Task";
