 ...
 * 主页面
 */
public class MMainActivity extends SwipeBackActivity {
    ...
    private void initView() {
        ...
        gdMainPageMenu.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (position) {
                    case 0:
                        intent = new Intent(MMainActivity.this, PowerStationCheckActivity.class);
                        startActivity(intent);
                        break;
                    case 1:
                        break;
                    case 4:
                        intent = new Intent(MMainActivity.this, Splash.class);
                        startActivity(intent);
                        break;
                    default:
                        break;
