...
package com.whut.smartlibrary.lib;
...
public class ViewDragHelper {
	...
	public static final int EDGE_SIZE = 50; // dp
	...
	/**
	 * Set the max velocity that will be detected as having a magnitude greater
	 * than zero in pixels per second. Callback methods accepting a velocity
	 * will be clamped appropriately.
	 * 
	 * @param maxVel
	 *            max velocity to detect
	 */
